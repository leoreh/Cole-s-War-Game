...
(function () {
  ...
  var he = {
    ...
    'menu.invite': 'הזמנה',
    'menu.confirmNew': 'המשחק הנוכחי יאבד.',
    'menu.confirmStart': 'להתחיל בכל זאת',
    'menu.confirmBack': 'חזרה',
    ...
    'settings.exportHint': 'הקוד של המשחק הנוכחי. אפשר להעתיק אותו ולפתוח את המשחק במכשיר אחר.',
    ...
    'settings.pasteFail': 'הדפדפן חסם את ההדבקה האוטומטית, אפשר להדביק בשדה ידנית',
    ...
    'invite.title': 'הזמנה למשחק',
    'invite.what': 'משחק מלחמה: משחק לוח לשני שחקנים על מכשיר אחד, בחינם ובלי להתקין כלום.',
    'invite.howTo': 'כדי לשים את המשחק על מסך הבית: פותחים את הקישור בספארי, מקישים על שיתוף ואז על הוספה למסך הבית.',
    'invite.shareGame': 'שיתוף המשחק הזה',
    'invite.gameWhat': 'משחק מלחמה: הקישור הזה פותח את המשחק בדיוק במצב שבו הוא נמצא עכשיו.',
    'invite.copy': 'העתקה',
    'invite.copied': 'ההודעה הועתקה',
    'invite.copyFail': 'ההעתקה לא הצליחה, אפשר לסמן את הטקסט ולהעתיק ידנית',
  ...
  var en = {
    ...
    'menu.invite': 'Invite',
    'menu.confirmNew': 'The current game will be lost.',
    'menu.confirmStart': 'Start anyway',
    'menu.confirmBack': 'Back',
    ...
    'invite.title': 'Invite',
    'invite.what': 'War Game: a board game for two players on one device, free and with nothing to install.',
    'invite.howTo': 'To put it on the home screen: open the link in Safari, tap Share and then Add to Home Screen.',
    'invite.shareGame': 'Share this game',
    'invite.gameWhat': 'War Game: this link opens the game exactly at the position it is in now.',
    'invite.copy': 'Copy',
    'invite.copied': 'The message was copied',
    'invite.copyFail': 'Copying failed, select the text and copy it by hand',
